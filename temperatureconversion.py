...
def celsius_to_fahrenheit(bot, trigger):
    ...
    try:
        ...
        bot.reply(
            "Could not understand input.  Please input the temperature in Celsius, e.g. !fa 100"
        )
        return False
...
def fahrenheit_to_celsius(bot, trigger):
    ...
    try:
        ...
        bot.reply(
            "Could not understand input.  Please input the temperature in Fahrenheit, e.g. !ce 100"
        )
        return False
