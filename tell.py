...
(Minor modifications by SnoopJeDi)
"""
...
# from require_privmsg_users import require_privmsg_users
...
def setup(self):
    ...
    self.memory["reminders"] = loadReminders(
        self.tell_filename, self.memory["tell_lock"]
    )
...
def f_remind(bot, trigger):
    ...
    dumpReminders(
        bot.tell_filename, bot.memory["reminders"], bot.memory["tell_lock"]
    )  # @@ tell
